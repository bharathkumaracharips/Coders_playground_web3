...
const DEFAULT_WORDS = ["HELLO", "WELCOME", "TO", "CODERS_BATTLE_GROUND"]
  ...
  return (
    <div className="flex items-center bg-transparent p-0 m-0">
      <canvas
        ...
        width={200}
        height={50}
        className="border border-gray-800 rounded-md shadow"
        style={{ width: "200px", height: "50px", background: "transparent" }}
      />
    </div>
  )
}
